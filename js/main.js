...
/* harmony import */ var _vendor_select_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/select.js */ "./src/js/vendor/select.js");
/* harmony import */ var _vendor_select_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_vendor_select_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _vendor_accordion_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vendor/accordion.js */ "./src/js/vendor/accordion.js");
/* harmony import */ var _vendor_accordion_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_vendor_accordion_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _vendor_tabs_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./vendor/tabs.js */ "./src/js/vendor/tabs.js");
/* harmony import */ var _vendor_tabs_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_vendor_tabs_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _vendor_slider_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./vendor/slider.js */ "./src/js/vendor/slider.js");
/* harmony import */ var _vendor_slider_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_vendor_slider_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _vendor_form_validate_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./vendor/form-validate.js */ "./src/js/vendor/form-validate.js");
/* harmony import */ var _vendor_search_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./vendor/search.js */ "./src/js/vendor/search.js");
/* harmony import */ var _vendor_search_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_vendor_search_js__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _vendor_showmore_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./vendor/showmore.js */ "./src/js/vendor/showmore.js");
/* harmony import */ var _vendor_showmore_js__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_vendor_showmore_js__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _vendor_play_btn_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./vendor/play-btn.js */ "./src/js/vendor/play-btn.js");
/* harmony import */ var _vendor_play_btn_js__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_vendor_play_btn_js__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _vendor_scroll_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./vendor/scroll.js */ "./src/js/vendor/scroll.js");
/* harmony import */ var _vendor_menu_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./vendor/menu.js */ "./src/js/vendor/menu.js");
/* harmony import */ var _vendor_menu_js__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_vendor_menu_js__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _vendor_ether_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./vendor/ether.js */ "./src/js/vendor/ether.js");
/* harmony import */ var _vendor_ether_js__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_vendor_ether_js__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _vendor_modal_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./vendor/modal.js */ "./src/js/vendor/modal.js");
/* harmony import */ var _vendor_modal_js__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_vendor_modal_js__WEBPACK_IMPORTED_MODULE_13__);
...
const control = document.querySelectorAll('.accordion-control');
control.forEach(element => {
  element.addEventListener('click', e => {
    const parent = e.currentTarget.parentNode;
    const items = parent.querySelectorAll('.guests__accordion-item');
    items.forEach(item => {
      item.classList.toggle('visible');
    });
    parent.classList.toggle('open');
    const content = parent.querySelector('.guests__accordion-content');
...
/***/ "./src/js/vendor/ether.js":
/*!********************************!*\
  !*** ./src/js/vendor/ether.js ***!
  \********************************/
/***/ (() => {

const etherBtn = document.querySelector('.header__ether-btn-320'),
  ether = document.querySelector('.header__ether-320');
etherBtn.addEventListener('click', () => {
  ether.classList.toggle('ether-open');
  etherBtn.classList.toggle('rotate');
});
...
/***/ "./src/js/vendor/form-validate.js":
/*!****************************************!*\
  !*** ./src/js/vendor/form-validate.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const menu = document.querySelector('.header__menu'),
  ...
  closeMenuBtn = menu.querySelector('.menu__close-btn'),
...
const entryBtn = document.querySelectorAll('.header__entry-btn'),
...
/***/ "./src/js/vendor/play-btn.js":
/*!***********************************!*\
  !*** ./src/js/vendor/play-btn.js ***!
  \***********************************/
/***/ (() => {

const etherMusicBtn = document.querySelectorAll('.header__btn-ether'),
  podcastsMusicBtn = document.querySelectorAll('.podcasts__card-btn');
function play(button) {
  button.forEach(btn => {
    btn.addEventListener('click', e => {
      const playBtn = e.currentTarget.querySelector('.play-btn');
      const pauseBtn = e.currentTarget.querySelector('.pause-btn');
      if (playBtn.classList.contains('current-btn')) {
...
/***/ "./src/js/vendor/showmore.js":
/*!***********************************!*\
  !*** ./src/js/vendor/showmore.js ***!
  \***********************************/
/***/ (() => {

const showMoreBtn = document.querySelector('.podcasts__more-btn');
...
const swiperMobile = new Swiper('.swiper-320', {
  direction: 'horizontal',
  loop: false,
  slidesPerView: 'auto',
  spaceBetween: 15
...
/***/ "./src/js/vendor/tabs.js":
/*!*******************************!*\
  !*** ./src/js/vendor/tabs.js ***!
  \*******************************/
/***/ (() => {

const tabs = document.querySelectorAll('.guests__accordion-item');
const guests = document.querySelectorAll('.guests__card');
tabs.forEach(element => {
  element.addEventListener('click', () => {
    let tabId = element.getAttribute('data-tab');
    let currentGuest = document.querySelector(tabId);
    tabs.forEach(tab => {
      tab.classList.remove('active-tab');
    });
    guests.forEach(guest => {
      guest.classList.remove('active-guest');
    });
    element.classList.add('active-tab');
    currentGuest.classList.add('active-guest');
  });
});
